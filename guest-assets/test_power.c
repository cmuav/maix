...
static int battery_time_to_empty = 3600;
static int battery_time_to_full = 3600;
...
module_param(battery_time_to_empty, int, 0644);
MODULE_PARM_DESC(battery_time_to_empty, "seconds until empty");
module_param(battery_time_to_full, int, 0644);
MODULE_PARM_DESC(battery_time_to_full, "seconds until full");
